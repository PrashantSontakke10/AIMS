...
export default function CourseDetail() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Error', e.response?.data?.message || 'Failed to save chapter');
    } finally {
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert('Error', e.response?.data?.message || 'Failed to delete chapter');
            }
          },
        },
      ]
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.actionRow}>
        <Text style={styles.chaptersCountText}>📂 {chapters.length} Chapters</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.chapterCard}>
            ...
            >
              ...
              <Text style={styles.viewLecturesLink}>Manage lectures & notes ➡️</Text>
            </TouchableOpacity>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>No chapters built in this course yet.</Text>
